...
const RentalSingleOffer = (props: Props) => {
  return (
    <>
      <div className="block sm:hidden mx-8 mt-8 rounded-xl  p-4 text-center relative  h-[600px] ">
        <div className=" w-full h-full absolute top-0 left-0 z-20  p-6 bg-black bg-opacity-50">
          {props.children}
          <Link
            href="rental/oferta"
            className="btn btn-outline mt-4 uppercase "
          >
            Zobacz ofertę
          </Link>
        </div>
